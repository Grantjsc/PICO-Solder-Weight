...
Module OCAP_Module
    ...
    Sub SaveData()
        ...
        Try
            con.Open()
            command = "INSERT INTO [OCAP_tb] ([Alarm],[Associate],[_date],[Machine],[Part_number],[Lot_number],[Test],[Root_cause],[Action]) VALUES (@alarm, @associate, @_date, @Machine, @Part_number, @Lot_number, @test, @Root_cause, @Action)"
