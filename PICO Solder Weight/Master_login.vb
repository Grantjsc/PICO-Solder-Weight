...
Public Class Master_login
    ...
    Public sp As SerialPort = Form1.SerialPort2
            ...
            If Not Features_Verify Is Nothing Then 'check if quality is good
                ...
                For Each dr As DataRow In dt.Rows
                    ...
                    If result.Verified Then
                        ...
                        StopCapture()
                        'Label1.Text = "Please scan your finger"
                        ...
                        ''If Add_Form.Enabled = False Then
                        'Add_Form.Enabled = True
                        ''ElseIf Remove_Form.Enabled = False Then
                        'Remove_Form.Enabled = True
                        'End If
                        Exit For
                ...
                If Not result.Verified Then
                    ...
                    Label1.Text = "No match. Authorized personnel only!"
